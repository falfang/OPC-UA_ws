...
static UA_StatusCode helloWorldMethodCallback(
    ...
    const UA_NodeId* metohdId, void* methodContext,
...
static void addHelloWorldMethod(UA_Server* server) {
    ...
    inputArgument.description = UA_LOCALIZEDTEXT("en-US", "A String input");
    ...
    outputArgument.description = UA_LOCALIZEDTEXT("en-US", "A String output");
...
/* Increase Array Value Mehtod */
static UA_StatusCode IncInt32ArrayMethodCallback(
    UA_Server* server,
