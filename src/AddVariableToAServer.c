...
static void addVariable(UA_Server* server) {
    ...
    attr.description = UA_LOCALIZEDTEXT("en-US", "the answer (description)");
    attr.displayName = UA_LOCALIZEDTEXT("en-US", "the answer (displayName)");
...
static void writeVariable(UA_Server* server) {
     ...
     * The above "UA_Server_writeValue" is syntactic sugar for writing a specific node attribute with the write service.
     */
    UA_WriteValue wv;
...
// Test function for writing wrong datatype value
